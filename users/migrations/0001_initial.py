    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_name', models.CharField(blank=True, max_length=10)),
                ('company_name', models.CharField(blank=True, max_length=15, null=True)),
                ('company_department', models.CharField(blank=True, max_length=15, null=True)),
                ('company_position', models.CharField(blank=True, max_length=15)),
